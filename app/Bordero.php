...
class Bordero extends Model
{
    ...
    public function setBorOutrosCstAttribute($value)
    {
        $this->attributes['bor_outros_cst'] = Number::unmask($value);
    }
